...
from schemas import User, UserList, UpdateUserSchema

users = [
    User(id=1, username='andreq2', first_name='Andrew', last_name='Johns', age=23, created_at=datetime.now()),
    User(id=2, username='mart3', first_name='Marti', last_name='Nurdback', age=23, created_at=datetime.now()),
    User(id=3, username='bw32', first_name='Billy', last_name='Johns', age=23, created_at=datetime.now()),
]
